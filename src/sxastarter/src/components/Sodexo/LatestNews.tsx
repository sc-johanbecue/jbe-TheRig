              ...
              <ul className="splide__list">
                ...
                <li className="splide__slide" role="group" style={{ width: 'calc(100%)' }}>
                  <article className="LatestNewsSlide_latest-news-slide__WLk__">
                    ...
                    <div className="LatestNewsSlide_latest-news-slide__content__fT26E">
                      <h3 className="LatestNewsSlide_latest-news-slide__content__title__0TF1Y LatestNewsSlide_font-h3__9qeWo">
                        Sodexo makes significant progress in Equileap’s global ranking, reaching 4th
                        place in France
                      </h3>
                      <div className="LatestNewsSlide_latest-news-slide__content__text__oVqab">
                        Sodexo is pleased to announce its significant progress in the 2025 Equileap
                        ranking, which recognizes the top-performing companies in terms of workplace
                        equality.
                      </div>
                      <div className="LatestNewsSlide_latest-news-slide__content__buttons__5sWAm">
                        <Link
                  ...
                  <article className="LatestNewsSlide_latest-news-slide__WLk__">
                    ...
                    <div className="LatestNewsSlide_latest-news-slide__content__fT26E">
                      ...
                      <div className="LatestNewsSlide_latest-news-slide__content__text__oVqab">
                        ...
                        Ethical Compagnies® for the second consecutive year. Issued by Ethisphere, a
                        global leader in defining and advancing the standards of ethical business,
                        this annual recognition honors Sodexo’s continuous commitment to business
                        integrity through best-in-class policies and practices. Learn more.
                      </div>
                      <div className="LatestNewsSlide_latest-news-slide__content__buttons__5sWAm">
                        <Link
                          target="_self"
                ...
                <li className="splide__slide" role="group" style={{ width: 'calc(100%)' }}>
                  <article className="LatestNewsSlide_latest-news-slide__WLk__">
                    ...
                    <div className="LatestNewsSlide_latest-news-slide__content__fT26E">
                      ...
                      <div className="LatestNewsSlide_latest-news-slide__content__text__oVqab">
                        Sodexo in Australia has been awarded a large five-year contract with Santos,
                        the largest supplier of natural gas in Australia. Discover more.
                      </div>
                      <div className="LatestNewsSlide_latest-news-slide__content__buttons__5sWAm">
                        <Link
                          target="_self"
