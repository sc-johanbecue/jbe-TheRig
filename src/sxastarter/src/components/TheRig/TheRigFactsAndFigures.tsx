  ...
  if (props.fields) {
    return (
      <div className="css-fy3zvu">
        <style jsx data-emotion="css 10r2m1s">{`
          .css-10r2m1s {
            padding: 80px 60px;
            margin: 0px;
            height: 405px;
        ...
        <div data-testid="FactsAndFigures" className="css-10r2m1s">
          <style jsx data-emotion="css tuxzvu">{`
            .css-tuxzvu {
          ...
          <div
            ...
            style={{ margin: '0px' }}
          >
            <style jsx data-emotion="css 15j76c0">{`
              .css-15j76c0 {
                box-sizing: border-box;
                margin: 0;
                -webkit-flex-direction: row;
            ...
            <div className="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12 MuiGrid-grid-sm-12 css-15j76c0">
              <style jsx data-emotion="css 1npb3ao">{`
                .css-1npb3ao {
              ...
              `}</style>
              <style jsx data-emotion="css 1y5qbxs">{`
                .css-1y5qbxs {
                  margin: 0;
          ...
          <style jsx data-emotion="css 1d3bbye">{`
            .css-1d3bbye {
              box-sizing: border-box;
              display: -webkit-box;
              display: -webkit-flex;
          ...
          <div className="MuiGrid-root MuiGrid-container fact-grid css-1d3bbye">
            <style jsx data-emotion="css 1q09act">{`
              .css-1q09act {
                box-sizing: border-box;
                margin: 0;
                -webkit-flex-direction: row;
            ...
            <div className="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12 MuiGrid-grid-md-2.4 MuiGrid-grid-lg-2.4 en-grid-item css-1q09act">
              <style jsx data-emotion="css 1wb1tnx">{`
                .css-1wb1tnx {
              ...
              <div className="css-1wb1tnx">
                <style jsx data-emotion="css 1q2jcol">{`
                  .css-1q2jcol {
                    font-family: 'Changa', sans-serif;
                    font-weight: 400;
                    color: #ff6a39;
                ...
                <style jsx data-emotion="css 1b171hf">{`
                  .css-1b171hf {
                    font-family: 'Changa', sans-serif;
                    font-weight: 400;
                    color: #ff6a39;
        ...
        <style jsx data-emotion="css 1xjbe9x">{`
          .css-1xjbe9x {
            position: absolute;
            bottom: -83px;
