  ...
  if (props.fields) {
    return (
      <footer className="css-1xiwo48">
        ...
        <style jsx data-emotion="css 1oguv67">{`
          .css-1oguv67 {
        ...
        `}</style>
        <style jsx data-emotion="css 14epr7c">{`
          .css-14epr7c {
            --Grid-columns: 12;
        ...
        <div className="MuiGrid-root MuiGrid-container MuiGrid-direction-xs-row css-14epr7c">
          <style jsx data-emotion="css scklcb">{`
            .css-scklcb {
              --Grid-columns: 12;
          ...
          <div className="MuiGrid-root MuiGrid-container MuiGrid-direction-xs-row MuiGrid-grid-sm-12 MuiGrid-grid-md-12 css-scklcb">
            <style jsx data-emotion="css 1ecy7u2">{`
            ...
            `}</style>
            <style jsx data-emotion="css 16o6wsf">{`
              .css-16o6wsf {
                --Grid-columns: 12;
            ...
            <div className="MuiGrid-root MuiGrid-container MuiGrid-direction-xs-row MuiGrid-grid-sm-6 MuiGrid-grid-md-6 hide-pif css-16o6wsf">
              <style jsx data-emotion="css 1v7fosp">{`
                .css-1v7fosp {
              ...
              `}</style>
              <style jsx data-emotion="css 11tvyti">{`
                .css-11tvyti {
                  min-width: 0;
                  box-sizing: border-box;
            ...
            <style jsx data-emotion="css 1sw6vb">{`
              .css-1sw6vb {
                min-width: 0;
                box-sizing: border-box;
                padding: calc(var(--Grid-rowSpacing1) / 2) calc(var(--Grid-columnSpacing1) / 2);
            ...
            <div className="MuiGrid-root MuiGrid-direction-xs-row MuiGrid-grid-sm-6 MuiGrid-grid-md-6 css-1sw6vb">
              <style jsx data-emotion="css 172taml">{`
                .css-172taml {
                  min-width: 0;
                  box-sizing: border-box;
                  padding: calc(var(--Grid-rowSpacing1) / 2) calc(var(--Grid-columnSpacing1) / 2);
          ...
          <style jsx data-emotion="css 1bldu4w">{`
            .css-1bldu4w {
              --Grid-columns: 12;
              --Grid-columnSpacing1: var(--Grid-columnSpacing);
              --Grid-rowSpacing1: var(--Grid-rowSpacing);
          ...
          <div className="MuiGrid-root MuiGrid-container MuiGrid-direction-xs-row MuiGrid-grid-sm-12 MuiGrid-grid-md-12 css-1bldu4w">
            <style jsx data-emotion="css 6zothf">{`
              .css-6zothf {
                min-width: 0;
                box-sizing: border-box;
                padding: calc(var(--Grid-rowSpacing1) / 2) calc(var(--Grid-columnSpacing1) / 2);
            ...
            <div className="MuiGrid-root MuiGrid-direction-xs-row MuiGrid-grid-sm-12 MuiGrid-grid-md-6 MuiGrid-grid-lg-7 css-6zothf">
              <style jsx data-emotion="css 1cchult">{`
                .css-1cchult {
                  margin-bottom: 20px;
                }
                @media screen and (max-width: 899px) {
              ...
              <div className="css-1cchult">
                <style jsx data-emotion="css 10frtmk">{`
                  .css-10frtmk {
              ...
              <style jsx data-emotion="css jqavj3">{`
                .css-jqavj3 {
                  display: -webkit-box;
                  display: -webkit-flex;
                  display: -ms-flexbox;
              ...
              <div className="css-jqavj3">
                <style jsx data-emotion="css rtflpr">{`
                  .css-rtflpr {
                    width: 36px;
                    position: relative;
                    height: 36px;
                ...
                <Link className="disable 2-disable css-rtflpr" target="" href="javascript:void(0);">
                  ...
                  <style jsx data-emotion="css 1xr9vc3">{`
                    .css-1xr9vc3 {
                      visibility: hidden;
                      bottom: -29px;
            ...
            <style jsx data-emotion="css 1nbejvw">{`
              .css-1nbejvw {
                --Grid-columns: 12;
                --Grid-columnSpacing2: var(--Grid-columnSpacing1);
                --Grid-rowSpacing2: var(--Grid-rowSpacing1);
            ...
            <div className="MuiGrid-root MuiGrid-container MuiGrid-direction-xs-row MuiGrid-grid-lg-5 MuiGrid-grid-md-6 MuiGrid-grid-xs-12 MuiGrid-grid-sm-12 css-1nbejvw">
              <style jsx data-emotion="css xe0fef">{`
                .css-xe0fef {
                  width: 100%;
                  display: -webkit-box;
                  display: -webkit-flex;
              ...
              `}</style>
              <style jsx data-emotion="css 1e2r27i">{`
                .css-1e2r27i {
                  -webkit-box-flex: 0;
                  -webkit-flex-grow: 0;
                  -ms-flex-positive: 0;
              ...
              <div className="MuiGrid-root MuiGrid-direction-xs-row MuiGrid-grid-xs-12 MuiGrid-grid-sm-12 MuiGrid-grid-md-12 css-1e2r27i">
                <style jsx data-emotion="css 1496lx8">{`
                  .css-1496lx8 {
                    font-family: 'Changa', sans-serif !important;
                    font-style: normal;
                    font-weight: 400;
                ...
                <style jsx data-emotion="css yw3nq1">{`
                  .css-yw3nq1 {
                    display: -webkit-box;
                    display: -webkit-flex;
                    display: -ms-flexbox;
                ...
                <form className="css-yw3nq1">
                  <style jsx data-emotion="css 1w17zfj">{`
                    .css-1w17zfj {
                      display: -webkit-box;
                      display: -webkit-flex;
                      display: -ms-flexbox;
                  ...
                  <div style={{ marginRight: '15px', marginLeft: '0px' }} className="css-1w17zfj">
                    <style jsx data-emotion="css vquyny">{`
                      .css-vquyny {
                  ...
                  <style jsx data-emotion="css 1xth1r">{`
                    .css-1xth1r {
                      font-family: 'Changa', sans-serif !important;
                      font-style: normal;
                      font-weight: 600;
                  ...
                  >
                    <style jsx data-emotion="css 9c55vl">{`
                      .css-9c55vl {
                        font-family: 'Changa', sans-serif !important;
                        font-style: normal;
                        font-weight: 600;
                    ...
                    <style jsx data-emotion="css 6flbmm">{`
                      .css-6flbmm {
                ...
                <style jsx data-emotion="css pl0z93">{`
                  .css-pl0z93 {
                    height: 27.2px;
                    display: none;
                  }
        ...
        >
          <style jsx data-emotion="css 2v2l7j">{`
            .css-2v2l7j {
              -webkit-box-pack: start;
              -ms-flex-pack: start;
              -webkit-justify-content: start;
          ...
          `}</style>
          <style jsx data-emotion="css tq4q1u">{`
            .css-tq4q1u {
              -webkit-box-flex: 0;
              -webkit-flex-grow: 0;
              -ms-flex-positive: 0;
          ...
          <div className="MuiGrid-root MuiGrid-direction-xs-row MuiGrid-grid-xs-12 MuiGrid-grid-sm-12 MuiGrid-grid-md-6 css-tq4q1u">
            <style jsx data-emotion="css 1hrf48z">{`
              .css-1hrf48z {
                font-family: 'Changa', sans-serif !important;
                font-style: normal;
                font-weight: 400;
          ...
          <style jsx data-emotion="css 1umk73g">{`
            .css-1umk73g {
              font-family: 'Changa', sans-serif !important;
              font-style: normal;
              font-size: 1.8rem;
          ...
          `}</style>
          <style jsx data-emotion="css 1jwntlb">{`
            .css-1jwntlb {
              -webkit-box-flex: 0;
              -webkit-flex-grow: 0;
              -ms-flex-positive: 0;
        ...
        <style jsx data-emotion="css 1q37vrn">{`
          .css-1q37vrn {
            min-width: 0;
            box-sizing: border-box;
            padding: calc(var(--Grid-rowSpacing) / 2) calc(var(--Grid-columnSpacing) / 2);
        ...
        <div className="MuiGrid-root MuiGrid-direction-xs-row MuiGrid-grid-sm-6 MuiGrid-grid-md-6 show-pif css-1q37vrn">
          <style jsx data-emotion="css 1p600jf">{`
            .css-1p600jf {
              min-width: 0;
              box-sizing: border-box;
              padding: calc(var(--Grid-rowSpacing) / 2) calc(var(--Grid-columnSpacing) / 2);
