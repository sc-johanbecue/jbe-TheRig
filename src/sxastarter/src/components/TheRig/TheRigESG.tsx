  ...
  if (props.fields) {
    return (
      <div data-testid="egs-block-wrapper" className="css-i9vblt">
        <style jsx data-emotion="css q2d0bh">{`
          .css--q2d0bh {
            padding: 240px 0px;
          }
          .css-q2d0bh .egs-grid .en-grid-item .egsGrid:last-child > div {
            border: none;
          }
          .css-q2d0bh .egs-grid .ar-grid-item .egsGrid:last-child > div {
            border: none;
            max-width: 30ch;
          }
        ...
        `}</style>
        <style jsx data-emotion="css 18czceh">{`
          .css--18czceh {
            width: 100%;
            margin-left: auto;
        ...
        <div className="MuiContainer-root MuiContainer-maxWidthLg css-18czceh">
          <style jsx data-emotion="css 48vdzh">{`
            .css--48vdzh {
              -webkit-box-flex: 0;
              -webkit-flex-grow: 0;
              -ms-flex-positive: 0;
          ...
          <div className="MuiGrid-root MuiGrid-direction-xs-row MuiGrid-grid-md-12 MuiGrid-grid-sm-12 MuiGrid-grid-xs-12 MuiGrid-grid-lg-12 egs-grid css-48vdzh">
            <style jsx data-emotion="css 108vj9e">{`
              .css--108vj9e {
            ...
            <style jsx data-emotion="css v57kt1">{`
              .css--v57kt1 {
                --Grid-columns: 12;
            ...
            <div className="MuiGrid-root MuiGrid-container MuiGrid-direction-xs-row MuiGrid-spacing-xs-3 en-grid-item css-v57kt1">
              <style jsx data-emotion="css b3tb0r">{`
                .css--b3tb0r {
                  -webkit-box-flex: 0;
                  -webkit-flex-grow: 0;
                  -ms-flex-positive: 0;
              ...
              <div className="MuiGrid-root MuiGrid-direction-xs-row MuiGrid-grid-sm-12 MuiGrid-grid-xs-12 MuiGrid-grid-md-3 MuiGrid-grid-lg-3 egsGrid css-b3tb0r">
                <style jsx data-emotion="css 1yjs7k1">{`
                  .css--1yjs7k1 {
                ...
                <div className="css-1yjs7k1">
                  <style jsx data-emotion="css 1hikysy">{`
                    .css--1hikysy {
                      display: -webkit-box;
                      display: -webkit-flex;
                      display: -ms-flexbox;
                  ...
                  <div className="css-1hikysy">
                    <style jsx data-emotion="css 12mq798">{`
                      .css--12mq798 {
                        width: 80px;
                        height: 80px;
                        margin-bottom: 16px;
                    ...
                    />
                    <style jsx data-emotion="css mxs5mc">{`
                      .css--mxs5mc {
                        font-family: 'Changa', sans-serif !important;
                        font-style: normal;
                        font-size: 1.8rem;
        ...
        <style jsx data-emotion="css 13wifey">{`
          .css--13wifey {
          ...
          @media screen and (max-width: 899px) {
            .css-13wifey {
              background: url('/rust/subscribeRus.png'), transparent 50% / cover no-repeat;
